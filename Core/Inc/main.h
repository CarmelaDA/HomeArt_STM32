...
#define Parcel_Garage_Pin GPIO_PIN_6
#define Parcel_Garage_GPIO_Port GPIOE
#define Parcel_Garage_EXTI_IRQn EXTI9_5_IRQn
...
#define Garaje_Servo_Pin GPIO_PIN_1
#define Garaje_Servo_GPIO_Port GPIOA
#define LDR_Pin GPIO_PIN_4
#define LDR_GPIO_Port GPIOA
#define Bedroom_Servo_Pin GPIO_PIN_7
#define Bedroom_Servo_GPIO_Port GPIOA
#define Living_Fan_1_Pin GPIO_PIN_4
#define Living_Fan_1_GPIO_Port GPIOC
#define Livin_Fan_2_Pin GPIO_PIN_5
#define Livin_Fan_2_GPIO_Port GPIOC
